{ inputs, config, pkgs, ... }: {
  home.file = {
    ...
    exec-once = swayidle before-sleep 'swaylock -f --color 000000' after-resume 'bluetoothctl connect 98:52:3D:6C:67:C2' & disown
...
#    }
    ...
    windowrulev2 = forceinput, class:^(jetbrains-idea-ce)$
